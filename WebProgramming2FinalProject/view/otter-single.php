...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Otters</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/european-otter.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Otters</h2>
            <p>An aquatic mammal that inhabits either rivers or the sea. Perfect for water-heavy environments.</p>
            <p class="text-primary">OTT4885</p>
            <p><strong class="text-primary h4">$1,500</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Otter','1',30);" class='btn btn-sm btn-primary'>
            </form>
          </div>
        </div>
      </div>
