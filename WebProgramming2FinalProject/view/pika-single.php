...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Pikas</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/pika.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Pikas</h2>
            <p>Very small mammals made popular by the popular pop culture phenomena: "Pokemon."</p>
            <p class="text-primary">PIK4991</p>
            <p><strong class="text-primary h4">$50,670</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Pika','1',30);" class='btn btn-sm btn-primary'>
            </form>
          </div>
        </div>
      </div>
