...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Snow Leopards</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/snow_leopard.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Snow Leopards</h2>
            <p>Lives in colder regions. Really not a suitable pet. Don't buy it unless you're a zoo. Seriously, don't.</p>
            <p class="text-primary">SNE4993</p>
            <p><strong class="text-primary h4">$50,250</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Leopard','1',30);" class='btn btn-sm btn-primary'>
            </form>
