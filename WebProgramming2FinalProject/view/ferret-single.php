...
<html lang="en">
  <head>
    <title>Ferrets &mdash; Colorlib e-Commerce Template</title>
    <meta charset="utf-8">
  ...
  <body>
   ...
   <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Ferrets</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/ferret.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Ferrets</h2>
            <p>A snake-like domesticated mammal that commonly serves as pets in areas where it is (and isn't) legal to own them.</p>
            <p class="text-primary">FER4887</p>
            <p><strong class="text-primary h4">$200</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Ferret','1',30);" class='btn btn-sm btn-primary'>
            </form>         
          </div>
        </div>
      </div>
