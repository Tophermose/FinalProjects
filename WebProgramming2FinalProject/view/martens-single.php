...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Martens</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/marten.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Martens</h2>
            <p>An agile animal that resides in the forests of the Northern Hemisphere. Keep an eye on your marten, if you look away it could be gone!</p>
            <p class="text-primary">MAR4888</p>
            <p><strong class="text-primary h4">$6,475</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Marten','1',30);" class='btn btn-sm btn-primary'>
            </form>
          </div>
        </div>
      </div>
