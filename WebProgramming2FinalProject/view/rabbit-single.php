  ...
  <body>
   ...
   <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Rabbits</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/rabbit.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Rabbits</h2>
            <p>Exists both domesticated in the wild, it is a common delicacy in Quebec. Please do not eat them.</p>
            <p class="text-primary">RAB4990</p>
            <p><strong class="text-primary h4">$100</strong></p>
            ...
            <form>
               <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Rabbit','1',30);" class='btn btn-sm btn-primary'>
            </form>
          </div>
        </div>
      </div>
