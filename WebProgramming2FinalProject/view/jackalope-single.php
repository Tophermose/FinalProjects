...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Jackalopes</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/jackalope.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Jackalopes</h2>
            <p>Totally real. Their antlers fall off all the time and don't grow back. That's totally normal. Yeah.</p>
            <p class="text-primary">JAC4992</p>
            <p><strong class="text-primary h4">$1,000,000</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Jackalope','1',30);" class='btn btn-sm btn-primary'>
          </div>
        </div>
      </div>
    </div>
