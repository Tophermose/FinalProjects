...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Panthers</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/panther.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Panthers</h2>
            <p>Not to be confused with Pansexuals. Known for being the protector of Wakanda... wait, is that right? </p>
            <p class="text-primary">PAN4995</p>
            <p><strong class="text-primary h4">$68,770</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Panther','1',30);" class='btn btn-sm btn-primary'>
            </form>
