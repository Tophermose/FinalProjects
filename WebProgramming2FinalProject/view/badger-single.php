...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Badgers</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/badger.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Badgers</h2>
            <p>An omnivore, it is a feral animal that resides all over the world! Known for having a violent temper so purchase with caution!</p>
            <p class="text-primary">BAD4886</p>
            <p><strong class="text-primary h4">$3,250</strong></p>
            ...
            <form>
              <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Badger','1',30);" class='btn btn-sm btn-primary'>            </form> 
          </div>
        </div>
      </div>
    </div>
