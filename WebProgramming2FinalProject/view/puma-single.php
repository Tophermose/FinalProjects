...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Pumas</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/puma.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Pumas</h2>
            <p>Native to the Americas. Also a very popular brand of shoe... those aren't made of actual puma, right?</p>
            <p class="text-primary">PUM4996</p>
            <p><strong class="text-primary h4">$45,000</strong></p>
            ...
            <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Puma','1',30);" class='btn btn-sm btn-primary'>
            </form>
