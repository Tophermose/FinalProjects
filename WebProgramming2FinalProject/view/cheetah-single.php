...
<html lang="en">
  ...
  <div class="site-wrap">
    <header class="site-navbar">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?choice=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Cheetahs</strong></div>
        </div>
      </div>
    </div> 
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="view/images/cheetah.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Cheetahs</h2>
            <p>Native to Africa. Really, really damn hard to catch. Like, wow, make yourself harder to sell, cheetahs.</p>
            <p class="text-primary">CHE4994</p>
            <p><strong class="text-primary h4">$75,000</strong></p>
           ...
           <form>
                <input type="button" value="Add To Cart" onclick="alert('Added to Shopping Cart');setCookie('Cheetah','1',30);" class='btn btn-sm btn-primary'>
            </form>
